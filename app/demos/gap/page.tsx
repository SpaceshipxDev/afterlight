...
const demoData = {
  ...
  skus: [
    {
      id: 'sku1',
      displayName: 'Waxed Canvas Baseball Hat',
      originalTitle: 'Waxed Canvas Baseball Hat',
      originalLink:
        'https://www.gap.com/browse/product.do?pid=8766380120000&vid=1#pdp-page-content',
      inputs: ['/gap/IMG_3678.jpeg', '/gap/IMG_3679.jpeg'],
      outputs: ['/gap/IMG_3680.jpeg', '/gap/IMG_3681.jpeg'],
    },
    {
      id: 'sku2',
      displayName: 'Braided Leather Belt',
      originalTitle: 'Braided Leather Belt',
      originalLink:
        'https://www.gap.com/browse/product.do?pid=684188012&vid=1#pdp-page-content',
      inputs: ['/gap/IMG_3656.jpeg', '/gap/IMG_3658.jpeg'],
      outputs: ['/gap/IMG_3673.jpeg', '/gap/IMG_3674.jpeg'],
    },
    {
      id: 'sku3',
      displayName: 'Waxed Canvas Tote Bag',
      originalTitle: 'Waxed Canvas Tote Bag',
      originalLink:
        'https://www.gap.com/browse/product.do?pid=8765130020000&vid=1#pdp-page-content',
      inputs: ['/gap/IMG_3663.jpeg', '/gap/IMG_3664.jpeg'],
      outputs: ['/gap/IMG_3675.jpeg', '/gap/IMG_3676.jpeg'],
    },
  ],
};
