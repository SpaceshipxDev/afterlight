...
const demoData = {
  agencyName: 'Blindsgalore',
  clientName: 'Blindsgalore',
  skus: [
    {
      id: 'sku1',
      displayName: 'Blindsgalore Essential Motorized Woven Wood Shades',
      originalTitle: 'Blindsgalore Essential Motorized Woven Wood Shades',
      originalLink:
...
export default function DemoPage() {
  ...
  const outputLabels = ['Installed hero', 'Raised view', 'Material detail'];
      ...
      <div className="mx-auto max-w-[1600px] px-6 py-12 md:py-28">
        <div className="mb-20 md:mb-24">
          ...
          <p className="mt-5 max-w-4xl text-lg leading-relaxed text-neutral-700 md:mt-6 md:text-2xl">
            We took one product image and turned it into richer photos copy,
            without another reshoot.
          </p>
        </div>
